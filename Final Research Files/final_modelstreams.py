...
def plot_tidalstreams(sat_galaxy, name_sat, sat_potential, xaxis, yaxis, sat_mass, sat_size, x_satgal, y_satgal,
    ...
    cluster_orbitb.plot(d1='R', d2='z', color='k', overplot=True, label='_Hidden label')
    ...
    d = 8.
    plt.plot(cluster_orbit.R(), cluster_orbit.z(), 'o', color='orange', ms=5., label = 'globular cluster')
    ...
    insitu_cluster = Orbit(vxvv=end_pos_cluster, ro=8.,
    ...
    # Model leading part of the stream
    spdf_insitu = streamspraydf(cluster_mass, progenitor=insitu_cluster, pot=mw, rtpot=mw, leading=True,
                                tdisrupt=t_disrupt)
    # Model trailing part of the tidal stream
    spdft_insitu = streamspraydf(cluster_mass, progenitor=insitu_cluster, pot=mw, rtpot=mw, leading=False,
                                 tdisrupt=t_disrupt)
    ...
    insitu_clusterb.plot(d1='R', d2='z', color='k', overplot=True, label='_Hidden label')
    ...
    # Convert from natural units to physical units
    d = 8.
    plt.plot(insitu_cluster.R(), insitu_cluster.z(), 'o', color='orange', ms=5., label = 'globular cluster')
